...
const ConfigName ="GridDemo"

// which configuration to read for the current puzzle collection
const whichDefaultConfig = "grid";   //possible values come out of the PanoPuzzle_config.js 
...
"grid" : [
	[4,"Demonstration of the available <br>build-in grid patterns","Bernd Kronmueller","30th January 2021"],
	 
	["<h2 class='txt'>- 44 piece</h2>",
	 1,77,0xFF0000,"pano1","gr_44"
	],	

	["<h2 class='txt'>- 54 pieces</h2>",
	 2,75,0x26A69A ,"pano1","gr_54"
	],

	["<h2 class='txt'>- 58 pieces</h2>",
	 3,75,0xC0392B ,"pano1","gr_58"
	],
	
	["<h2 class='txt'>- 66 pieces</h2>",
	 4,80,0x000000,"pano1","gr_66"
	],

	["<h2 class='txt'>- 68 pieces</h2>",
	 5,75,0xF7DC6F ,"pano1","gr_68"
	],

	["<h2 class='txt'>- 72 pieces</h2>",
	 6,75,0xC0392B ,"pano1","gr_72"
	],	
	
	["<h2 class='txt'>- 80 pieces</h2>",
	 7,70,0xF7DC6F,"pano1","gr_80"
	],
	
	["<h2 class='txt'>- 82 pieces</h2>",
	 8,70,0x26A69A,"pano1","gr_82"
	],
	
	["<h2 class='txt'>- 90 pieces</h2>",
	 9,75,0xC0392B ,"pano1","gr_90"
	],	

	["<h2 class='txt'>- 96 pieces</h2>",
	 10,75,0x26A69A ,"pano1","gr_96"
	],
	
	["<h2 class='txt'>- 122 pieces</h2>",
	 11,75,0x26A69A ,"pano1","gr_122"
	],
	
	["<h2 class='txt'>- 124 pieces</h2>",
	12,75,0xC0392B ,"pano1","gr_124"
	],
	
	["<h2 class='txt'>- 132 pieces</h2>",
	 13,70,0xF7DC6F,"pano1","gr_132"
	]
  ]
